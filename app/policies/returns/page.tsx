  ...
  return (
    <main>
      ...
      <div className="pt-32 pb-24 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[16px] leading-7 text-gray-600">
          <div>
            <h3 className="text-navy-deep font-semibold mb-2 text-[18px]">Return window</h3>
            <p>If an item arrives damaged or defective, you can request a return or exchange within 3 days of delivery.</p>
          </div>
          <div>
            <h3 className="text-navy-deep font-semibold mb-2 text-[18px]">Condition</h3>
            <p>The item must be returned unused, in its original packaging, with all tags attached.</p>
          </div>
          <div>
            <h3 className="text-navy-deep font-semibold mb-2 text-[18px]">How to request</h3>
