...
export type Product = {
  ...
  materials?: string[];
  /** true = sold out. Page khulega, lekin Add to Cart band hoga. */
  soldOut?: boolean;
};
...
export const products: Product[] = [
  ...
  {
    id: "41",
    name: "Classic Silver Twist Ring",
    category: "Ring",
    price: "Rs. 549",
    priceValue: 549,
    shape: "circle",
  ...
  {
    id: "42",
    name: "Gold Dainty Sparkle Open Ring",
    category: "Ring",
    price: "Rs. 549",
    priceValue: 549,
    shape: "circle",
  ...
  {
    id: "44",
    name: "Silver Butterfly Open Ring",
    category: "Ring",
    price: "Rs. 549",
    priceValue: 549,
    shape: "circle",
  ...
  {
    id: "45",
    name: "Silver Sunflower Zircon Necklace",
    category: "Sets",
    price: "Rs. 599",
    priceValue: 599,
    shape: "band",
...
type CategoryDetail = { blurb: string; materials: string[]; care: string; shipping: string };
